...
export default class AbstractRepository<T extends Document> {
   ...
   * @param attributes
   */
  public async create(attributes: Record<string, any>, options?: SaveOptions | undefined) {
   ...
   *
   */
  public async findOneAndUpdate(conditions, updatedData, options?: QueryOptions | undefined) {
   ...
   * Update many
   */
  public async updateMany(conditions, updatedData, options?: QueryOptions | undefined) {
   ...
   * @returns
   */
  public aggregate<T>(pipeline: PipelineStage[], options?: AggregateOptions) {
